...
import models.*;
/**
 * Classe responsável por receber as informações a serem atualizadas e armazenadas
 * , informações que são recebidas das respectivas telas de passagem no pacote view,
 * nos atributos da classe Database
 ...
 */
	...
	/**
	 * Método que remove uma passagem da lista de passagens de um ticket
	 * com base no valor fornecido da posição da passagem e no itinerário
	 * que possui a passagem
	...
	/**
	 * Método que valida se o preço e o número de uma poltrona
	...
	/**
	 * Método que recebe um inteiro que indica qual o tipo de poltrona
	 * deve ser retornao
	 * @param i
	...
	/**
	 * Método responsável por armazenar a posição da passagem a ser armazenada,
	 * que também informa a tela de edição 
	 * @param Index
	 */
